...
public class MemberRepository {
    ...
    public Member findByRefreshToken(String refreshToken) throws NoResultException {
        Member findMembers = em.createQuery("select m from Member m where m.refreshToken = :refreshToken", Member.class)
